...
```
Graph explanation: the size of dot means the number of crime. As number of crime increase, the size of dot increase. The color from dark to bright means median income from low to high.
