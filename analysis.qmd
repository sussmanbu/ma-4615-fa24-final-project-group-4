...
This also removed any race with a P-Value over 0.8 and any races like "unknown" and "other" because that doesn't give much information. We can see that for the most part, as median income increases, the likelihood of a crime decreases. This is not the case for 
